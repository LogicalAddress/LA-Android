...
import ng.com.nhub.paygis.time.FastDateFormat;
...
public class LocaleController {
    ...
    public LocaleController() {
        ...
        is24HourFormat = DateFormat.is24HourFormat(ApplicationLoader.appContext);
        LocaleInfo currentInfo = null;
        boolean override = false;

        try {
            SharedPreferences preferences = ApplicationLoader.appContext.getSharedPreferences("mainconfig", Activity.MODE_PRIVATE);
        ...
        try {
            ...
            ApplicationLoader.appContext.registerReceiver(new TimeZoneChangedReceiver(), timezoneFilter);
        } catch (Exception e) {
            FileLog.e("tmessages", e);
        }
    }
    ...
    public boolean applyLanguageFile(File file) {
        try {
            ...
            if (languageName != null && languageName.length() > 0 &&
                ...
                File finalFile = new File(ApplicationLoader.appContext.getFilesDir(), languageCode + ".xml");
    ...
    private void saveOtherLanguages() {
        SharedPreferences preferences = ApplicationLoader.appContext.getSharedPreferences("langconfig", Activity.MODE_PRIVATE);
    ...
    public void applyLanguage(LocaleInfo localeInfo, boolean override, boolean fromFile) {
        ...
        try {
            ...
            if (newLocale != null) {
                ...
                ApplicationLoader.appContext.getResources().updateConfiguration(config, ApplicationLoader.appContext.getResources().getDisplayMetrics());
    ...
    private String getStringInternal(String key, int res) {
        ...
        if (value == null) {
            value = ApplicationLoader.appContext.getString(res);
        }
        return value;
    }
    ...
    public static String formatPluralString(String key, int plural) {
        ...
        param = key + "_" + param;
        int resourceId = ApplicationLoader.appContext.getResources().getIdentifier(param, "string", ApplicationLoader.appContext.getPackageName());
